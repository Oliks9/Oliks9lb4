...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['fileToDecompress'])) {
        ...
        $fileContent = file_get_contents($_FILES['fileToDecompress']['tmp_name']);
        $codes = array_map('intval', explode(',', $fileContent));
    ...
    <header>
        <div class="container">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="/Oliks9lb4/lzw.php">LZW эффективное</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/Oliks9lb4/lzw2.php">LZW циферки</a>
                </li>
            </ul>
        </div>
    </header>
